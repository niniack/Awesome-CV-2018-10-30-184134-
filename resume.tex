...
\name{Nishant Suresh}{Aswani}
\position{Computer Engineer{\enskip\cdotp\enskip}Biologist}
%\address{246-1002, Gwangmyeongmayrouge Apt. 86, Cheongna lime-ro, Seo-gu, Incheon-si, 404-180, Rep. of KOREA}

\mobile{(+971) 50-106-5724}
\email{nishantaswani@nyu.edu}
\homepage{www.nishantaswani.com}
\github{niniack}
\linkedin{nishantaswani}
% \gitlab{gitlab-id}
